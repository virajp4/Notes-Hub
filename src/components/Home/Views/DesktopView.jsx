...
export default function DesktopView() {
  return (
    <div className="h-fill hidden xl:block 2xl:hidden">
      <Parallax pages={2} className="bg-black font-bebas">
        ...
        <ParallaxLayer offset={0.85} speed={1} factor={2}>
        ...
        <ParallaxLayer offset={1.78} speed={1} factor={1} className="flex w-[10%] ml-[15.655%] max-w-fit">
          <a
        ...
        <ParallaxLayer offset={1.72} speed={1} factor={1} className="flex w-[10%] ml-[46.5%] max-w-fit">
          <a
        ...
        <ParallaxLayer offset={1.69} speed={1.5} factor={1} className="flex w-[10%] ml-[80.5%] max-w-fit">
          <a
