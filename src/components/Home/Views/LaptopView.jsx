...
export default function LaptopView() {
  return (
    <div className="h-fill hidden lg:block xl:hidden">
      <Parallax pages={1.8} className="bg-black font-bebas">
        ...
        <ParallaxLayer offset={0.01} speed={-1.7} factor={2}>
          <div className="earth-container w-[20%] ml-[40%] scale-50">
            <img src={EarthIMG} className="rounded-full shadow-[0_0_100px_rgba(30,155,255,0.65)]" style={{ width: "100%" }} />
          </div>
        </ParallaxLayer>
        <ParallaxLayer offset={0.1} speed={-1.5} factor={2}>
          <div className="jupiter-container w-[15%] ml-[70%] scale-75">
        ...
        <ParallaxLayer offset={1} speed={1.3} factor={1} className="flex justify-center">
          <h1 className="text-4xl md:text-7xl text-white text-center cursor-default">Next cosmic stop?</h1>
        </ParallaxLayer>
        <ParallaxLayer offset={1.3} speed={1} factor={1} className="flex w-[10%] ml-[15.3%] max-w-fit">
          <a
        ...
        <ParallaxLayer offset={1.35} speed={1} factor={1} className="flex w-[10%] ml-[48%] max-w-fit">
          <a
        ...
        <ParallaxLayer offset={1.18} speed={1.5} factor={1} className="flex w-[10%] ml-[75%] max-w-fit">
          <a
